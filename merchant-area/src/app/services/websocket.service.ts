...
import {IWebsocketService, IWsMessage, WebSocketConfig} from '../module/websocket/websocket.interfaces';
import { config } from '../module/websocket/websocket.config';
...
export class WebsocketService implements IWebsocketService, OnDestroy {
    ...
    public get isConn(): boolean { return this.isConnected; }
    ...
    constructor(@Inject(config) private wsConfig: WebSocketConfig) {
        ...
        this.reconnectAttempts = wsConfig.reconnectAttempts || 20; // number of connection attempts
